...
public  const string DefaultPredatorImage = "S";
public  const string ObstacleImage = "0";
public  const string BorderImage = "*";
public  const int TimeToFeed = 6;
public  const int TimeToReproduce = 6;
public  const int NumOfNeighbors = 4;
public  const int NumBetweenIterations = 2000; //1000 = 1 second
